 ...
 * @param cwd
 * @param pkg
 * @returns eslint-rules-config/index
 * @returns eslint-rules-config/react
 * @returns eslint-rules-config/typescript/index
 * @returns eslint-rules-config/typescript/react
 */
